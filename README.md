...
BEGIN
    ...
    IF existing_count > 0 THEN
        ...
        'Each order can only have one tracking information');
    END IF;
END;
/
...
CREATE TABLE PAYMENT_DETAILS (
    ...
    CASH VARCHAR2(10) DEFAULT 'YES' NOT NULL,
    CARD VARCHAR2(30),
    CUSTOMER_ID INT NOT NULL,
...
(202000846, 'Haifa', 'Almutairi', 'Abdullah St', 'haifa00', 'haifa', '31952', 'Dammam', 'Eastern');

INSERT INTO CUSTOMER VALUES
(202301026, 'Najla', 'Algarni', 'Khaled Road', 'najla321', 'najla', '21411', 'Jeddah', 'Makkah');

-- =========================
-- ORDERS
-- =========================
INSERT INTO ORDERS VALUES
(101, TO_DATE('2025-01-10','YYYY-MM-DD'), 299.99, 202301026);

INSERT INTO ORDERS VALUES
(102, TO_DATE('2025-01-12','YYYY-MM-DD'), 149.50, 202000846);

-- =========================
-- PAYMENT DETAILS
-- =========================
INSERT INTO PAYMENT_DETAILS VALUES
(9002, TO_DATE('2025-01-12','YYYY-MM-DD'), 'Cash', 'YES', NULL, 202000846);

INSERT INTO PAYMENT_DETAILS VALUES
(9001, TO_DATE('2025-01-10','YYYY-MM-DD'), 'Card', 'NO', '123456789', 202301026);
...
-- WEBSITE
-- =========================
INSERT INTO WEBSITE VALUES ('HN-CLOTHS', 202000846);
